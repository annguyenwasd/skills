...
**What to include:** for each decision or rule in the Resolved Plan that describes observable app behaviour, write one checklist item as:
`When [condition], [subject] [action/result]`
